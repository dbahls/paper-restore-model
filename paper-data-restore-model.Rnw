...
%Researchers can make use of these information resources directly from within their research environment and run on updated data....
...
%BZ: was genau meinst du mit the material? unseren code? restored data (references)?
